...
function MainPage() {
  ...
  const { publish } = useRoomSocket(roomUuid, myParticipantId, {
    // 재설정은 재계산까지 끝난 좌표를 보내므로 지도를 비우지 않는다.
    // 식당 목록과 준비 상태는 기존 restaurants, participants/ready 토픽으로 갱신된다.
    "midpoint/reset": (midpoint) => {
